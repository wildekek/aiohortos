...
@pytest.mark.parametrize(
    ("identifier", "expected"),
    [
        ("OutsideTemperature-Measured", "outsidetemperature"),
        ("MaximumPipeTemperature-ActualSetting", "maximumpipetemperature"),
        # No kind suffix at all.
        ("OutsideTemperature", "outsidetemperature"),
        ("", ""),
    ],
)
def test_readout_subject(identifier: str, expected: str) -> None:
    """Test the subject is the identifier without its kind suffix."""
    assert readout_subject(identifier) == expected
